          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <Link href={`/notion-page/${notionPageId}`} passHref>
              <div className="cursor-pointer overflow-hidden rounded-lg shadow-md bg-white hover:shadow-lg transition-shadow">
                ...
                />
                <div className="p-4">
                    <h5 className="text-lg font-semibold text-center text-gray-900 dark:text-gray-900">Blog</h5>
                </div>
              </div>
            </Link>
            <Link href="#" passHref>
              ...
              <img
                ...
                />
                <div className="p-4">
                <h5 className="text-lg font-semibold text-center text-gray-900 dark:text-gray-900">Projects</h5>
                </div>
              </div>
            </Link>
            <Link href="#" passHref>
              ...
              <img
                ...
                />
                <div className="p-4">
                <h5 className="text-lg font-semibold text-center text-gray-900 dark:text-gray-900">Chats</h5>
                </div>
              </div>
            </Link>
            <Link href="#" passHref>
              ...
              <img
                ...
                />
                <div className="p-4">
                <h5 className="text-lg font-semibold text-center text-gray-900 dark:text-gray-900">Quests</h5>
                </div>
              </div>
            </Link>
          </div>
